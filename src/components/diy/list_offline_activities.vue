<template>
	<div class="diy_home diy_list diy_offline_activities" id="diy_offline_activities_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x">
					<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/offline_activities/details?offline_activities_id=' + o['offline_activities_id']">
										<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/offline_activities/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="($check_field('get',item.name,'/offline_activities/details') && +item.is_img_list) || $check_option('/offline_activities/details', 'can_show_score')">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table">
			<table class="diy_table">
				<tr class="diy_row">
							<th class="diy_title" v-if="$check_field('get','activity_name','/offline_activities/list')">
					活动名称
				</th>
										<th class="diy_title" v-if="$check_field('get','activity_type','/offline_activities/list')">
					活动类型
				</th>
											<th class="diy_title" v-if="$check_field('get','activity_date','/offline_activities/list')">
					活动日期
				</th>
								</tr>
								<tr class="diy_row" v-for="(o,i) in list" :key="o+i" @click="to_detail(o)">
												<td class="diy_field diy_text" v-if="$check_field('get','activity_name','/offline_activities/list')">
						<span>
							{{ o["activity_name"] }}
						</span>
					</td>
											<td class="diy_field diy_text" v-if="$check_field('get','activity_type','/offline_activities/list')">
						<span>
							{{ o["activity_type"] }}
						</span>
					</td>
												<td class="diy_field diy_date" v-if="$check_field('get','activity_date','/offline_activities/list')">
						<span>
		...
		<!-- 轮播 -->
		 ...
		 <div class="carousel ins_s">
                <div class="slider" ref="slider">
                    ...
                    <router-link :to="'/offline_activities/details?offline_activities_id=' + o['offline_activities_id']" class="lis_cont">
						                        <div class="diy_list_img_box" v-if="imgList.length" >
    					        <div class="diy_row" v-for="(item, index) in imgList" :key="item + index" v-show="$check_field('get',item.name,'/offline_activities/details') && +item.is_img_list">
    						<div class="diy_title diy_list_img_title">
                    ...
                    <div class="context">
                        <div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}"  v-if="$check_field('get',item.name,'/offline_activities/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
							<div class="diy_field diy_text">
...
<script>
	export default {
		...
		methods: {
			...
			to_detail(v){
				this.$router.push("/offline_activities/details?offline_activities_id="+v.offline_activities_id)
			},
