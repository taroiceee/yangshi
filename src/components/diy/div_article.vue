<template>
    <div class="div_article">
        ...
        <div class="aside list">
            ...
            <div class="btns_interact col-12 col-sm-6" v-if="this.$store.state.user.user_id">
                <!-- 点赞按钮 -->
                <b-button v-if="check_praised" @click="add_praise()" class="praise_btn praise_change">
					<b-icon icon="hand-thumbs-up-fill" class="icon_change"/>
                    <span class="word_change">点赞</span>
                </b-button>
				<b-button v-else @click="add_praise()" class="praise_btn">
					<b-icon icon="hand-thumbs-up" class=""></b-icon>
					<span>点赞</span>
				</b-button>
				<!-- 收藏按钮 -->
				<b-button v-if="check_collected" @click="add_collect()" class="collect_btn collect_change">
				    <b-icon icon="heart-fill" class="icon_change"/>
				    <span class="word_change">收藏</span>
				</b-button>
				<b-button v-else @click="add_collect()" class="collect_btn">
					<b-icon icon="heart" class=""></b-icon>
					<span>收藏</span>
				</b-button>
            </div>
        </div>
