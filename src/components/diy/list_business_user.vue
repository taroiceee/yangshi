<template>
	<div class="diy_home diy_list diy_business_user" id="diy_business_user_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x">
					<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/business_user/details?business_user_id=' + o['business_user_id']">
										<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/business_user/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="($check_field('get',item.name,'/business_user/details') && +item.is_img_list)">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table">
			<table class="diy_table">
				<tr class="diy_row">
							<th class="diy_title" v-if="$check_field('get','person_in_charge','/business_user/list')">
					负责人
				</th>
											<th class="diy_title" v-if="$check_field('get','shop_name','/business_user/list')">
					店铺名称
				</th>
										<th class="diy_title" v-if="$check_field('get','shop_phone','/business_user/list')">
					店铺电话
				</th>
										</tr>
								<tr class="diy_row" v-for="(o,i) in list" :key="o+i" @click="to_detail(o)">
												<td class="diy_field diy_text" v-if="$check_field('get','person_in_charge','/business_user/list')">
						<span>
							{{ o["person_in_charge"] }}
						</span>
					</td>
												<td class="diy_field diy_text" v-if="$check_field('get','shop_name','/business_user/list')">
						<span>
							{{ o["shop_name"] }}
						</span>
					</td>
											<td class="diy_field diy_phone" v-if="$check_field('get','shop_phone','/business_user/list')">
						<span>
							{{ o['shop_phone'] }}
						</span>
					</td>
		...
		<!-- 轮播 -->
		 ...
		 <div class="carousel ins_s">
                <div class="slider" ref="slider">
                    ...
                    <router-link :to="'/business_user/details?business_user_id=' + o['business_user_id']" class="lis_cont">
						                        <div class="diy_list_img_box" v-if="imgList.length" >
    					        <div class="diy_row" v-for="(item, index) in imgList" :key="item + index" v-show="$check_field('get',item.name,'/business_user/details') && +item.is_img_list">
    						<div class="diy_title diy_list_img_title">
...
<script>
	export default {
		...
		methods: {
			...
			to_detail(v){
				this.$router.push("/business_user/details?business_user_id="+v.business_user_id)
			},
