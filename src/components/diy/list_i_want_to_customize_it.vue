<template>
	<div class="diy_home diy_list diy_i_want_to_customize_it" id="diy_i_want_to_customize_it_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x">
					<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/i_want_to_customize_it/details?i_want_to_customize_it_id=' + o['i_want_to_customize_it_id']">
										<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/i_want_to_customize_it/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="($check_field('get',item.name,'/i_want_to_customize_it/details') && +item.is_img_list)">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table">
			<table class="diy_table">
				<tr class="diy_row">
							<th class="diy_title" v-if="$check_field('get','order_number','/i_want_to_customize_it/list')">
					订单号
				</th>
											<th class="diy_title" v-if="$check_field('get','name_of_commodity','/i_want_to_customize_it/list')">
					商品名称
				</th>
											<th class="diy_title" v-if="$check_field('get','commodity_cover','/i_want_to_customize_it/list')">
					商品封面
				</th>
																						</tr>
								<tr class="diy_row" v-for="(o,i) in list" :key="o+i" @click="to_detail(o)">
												<td class="diy_field diy_text" v-if="$check_field('get','order_number','/i_want_to_customize_it/list')">
						<span>
							{{ o["order_number"] }}
						</span>
					</td>
												<td class="diy_field diy_text" v-if="$check_field('get','name_of_commodity','/i_want_to_customize_it/list')">
						<span>
							{{ o["name_of_commodity"] }}
						</span>
					</td>
												<td class="diy_field" v-if="$check_field('get','commodity_cover','/i_want_to_customize_it/list')">
		...
		<!-- 轮播 -->
		 ...
		 <div class="carousel ins_s">
                <div class="slider" ref="slider">
                    ...
                    <router-link :to="'/i_want_to_customize_it/details?i_want_to_customize_it_id=' + o['i_want_to_customize_it_id']" class="lis_cont">
						                        <div class="diy_list_img_box" v-if="imgList.length" >
    					        <div class="diy_row" v-for="(item, index) in imgList" :key="item + index" v-show="$check_field('get',item.name,'/i_want_to_customize_it/details') && +item.is_img_list">
    						<div class="diy_title diy_list_img_title">
...
<script>
	export default {
		...
		methods: {
			...
			to_detail(v){
				this.$router.push("/i_want_to_customize_it/details?i_want_to_customize_it_id="+v.i_want_to_customize_it_id)
			},
