				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 生鲜商品 -->
							<div><span>生鲜商品</span></div>
							<table_fresh_goods v-if="$check_action('/fresh_goods/table','get')"></table_fresh_goods>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_fresh_goods from "../../components/diy/table_fresh_goods.vue";
	export default {
		data() {
			return {
			};
