				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<table_feedback_on_opinions v-if="$check_action('/feedback_on_opinions/table','get')"></table_feedback_on_opinions>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_feedback_on_opinions from "../../components/diy/table_feedback_on_opinions.vue";
	export default {
		data() {
			return {
			};
