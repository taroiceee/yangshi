				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_registered_user v-if="$check_action('/registered_user/view','get')"></view_registered_user>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_registered_user from "../../components/diy/view_registered_user.vue";
	export default {
		data() {
			return {
			};
