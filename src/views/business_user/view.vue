				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 商家用户 -->
							<div><span>商家用户</span></div>
							<view_business_user v-if="$check_action('/business_user/view','get')"></view_business_user>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_business_user from "../../components/diy/view_business_user.vue";
	export default {
		data() {
			return {
			};
